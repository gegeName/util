 ...
 * `com.chat.uifoundation.http.launchApi` 使用，code 不为 SUCCESS 时抛 [ApiException]，
...
private const val SELF_KT_PREFIX = "com.chat.uifoundation.http.HttpResultExtKt"
private const val HTTP_RESULT_PREFIX = "com.chat.uifoundation.http.HttpResult"
